...
import type AnimatedHeadingStylesStyles from "./animated-heading-styles.opti-style.json"
import type HeadingStylesStyles from "./heading-styles.opti-style.json"
